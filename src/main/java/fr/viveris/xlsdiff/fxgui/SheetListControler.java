...
public class SheetListControler implements Initializable {
	...
	//
	// private final ObservableList<Person> masterData = FXCollections
	// .observableArrayList();

	public SheetListControler() {
		// this.masterData.add(new Person("Hans", "Muster"));
		// this.masterData.add(new Person("Ruth", "Mueller"));
		// this.masterData.add(new Person("Heinz", "Kurz"));
		// this.masterData.add(new Person("Cornelia", "Meier"));
		// this.masterData.add(new Person("Werner", "Meyer"));
		// this.masterData.add(new Person("Lydia", "Kunz"));
		// this.masterData.add(new Person("Anna", "Best"));
		// this.masterData.add(new Person("Stefan", "Meier"));
		// this.masterData.add(new Person("Martin", "Mueller"));
	}
